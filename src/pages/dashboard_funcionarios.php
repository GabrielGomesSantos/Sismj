        ...
        <li>
            <a href="dashboard.php?pag=1">
                <div class="centralizar">
                    ...
                    <span style=" margin-left: 5px; " class="titulo">Processos</span>
                </div>
            </a>
        </li>
        <li>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header bg-info text-white">
                            ...
                            <button type="button" class="btn-close btn-light p-2 rounded-circle" data-bs-dismiss="modal" aria-label="Close">
                                <img src="../../assets/images/close.png" alt="Fechar" style="width: 20px;">
                            </button>
                        </div>
                        <div class="modal-body">
                            <?php include("cadastrar_funcionario.php") ?>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#excluirModal" onclick="getID(<?php echo $row['cod_funcionario'] ?>)">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-danger text-white">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir Funcionario</h1>
...
function excluirProcesso() {
    window.location.href = "remover_funcionario.php?id_funcionario=" + idSelecionado
}
</script>
<script>
$(function() {
