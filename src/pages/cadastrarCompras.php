            ...
            <div class="row justify-content-center">
                <div class="col-md-8 contents">
                    ...
                    <form action="sisman_db.php" method="post">
                        ...
                        <input type="submit" name="add_compra" value="Cadastrar" class="btn text-white btn-block btn-info mt-5">
                    </form>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $sql = "INSERT INTO compras (nota_fiscal, data, fornecedor)
                                VALUES ('$nota_fiscal', '$data', '$fornecedor')";
