...
$sql_total = "SELECT COUNT(*) FROM `medicos`";
...
$sql = "SELECT * FROM `medicos` LIMIT $items_per_page OFFSET $offset";
            ...
            <tbody>
                ...
                <td>
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluirModal"
                        onclick="getID(<?php echo $row['cod_medico'] ?>)">
                ...
                <td><a href="editar_medico.php?id_medico=<?php echo $row['cod_medico'] ?>" class="btn btn-warning"><i
                            class="bi bi-pencil text-white"></i></a></td>
                </tr>
...
function excluirProcesso() {
    window.location.href = "remover_medico.php?id_medico=" + idSelecionado
}
</script>
