                ...
                <div class="col-sm-10 offset-1">
                    <table class="table mt-5">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col-sm">cod. medicamento</th>
                                <th scope="col-sm">cod. compra</th>
                                <th scope="col-sm">nome medicamento</th>
                                <th scope="col-sm">tipo medicamento</th>
                                <th scope="col-sm">categoria</th>
                                <th scope="col-sm">laboratorio</th>
                                <th scope="col-sm">lote</th>
                                <th scope="col-sm">validade</th>
                                <th scope="col-sm">quantidade</th>
                            </tr>
                        </thead>
                        <tbody>
