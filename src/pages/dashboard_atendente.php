                    ...
                    <div>
                        <table class="table mt-4" id="TabelaMedicamentos">
                            ...
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col-sm">Medicamento</th>
                                    <th scope="col-sm">tipo</th>
                                    <th scope="col-sm">Laboratorio</th>
                                    <th scope="col-sm">Qnts</th>
                                </tr>
                            </thead>
            ...
            <div class="row">
                <div class="col-sm-10 offset-1">
                    <table class="table mt-5">
                        <thead class="thead-light">
                            <tr>
                                <th scope="col-sm">N°</th>
                                <th scope="col-sm">Nome do Paciente</th>
                                <th scope="col-sm">Cpf</th>
                                <th scope="col-sm">Cod. Processo</th>
